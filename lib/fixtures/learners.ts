...
export const mockLearners: LearnerRecord[] = [
  ...
  },
  {
    id: "lrn-009",
    name: "Wei Zhang",
    email: "wzhang@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-010",
    name: "Latoya Simmons",
    email: "lsimmons@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-011",
    name: "Ricardo Vega",
    email: "rvega@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-012",
    name: "Emily Chan",
    email: "echan@example-legalaid.org",
    role: "paralegal",
    jurisdiction: "Massachusetts",
  },
  {
    ...
    email: "nfitzgerald@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-014",
    name: "Grace Odom",
    email: "godom@example-legalaid.org",
    role: "support",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-015",
    name: "Karim Haddad",
    email: "khaddad@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-016",
    name: "Olivia Marsh",
    email: "omarsh@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-017",
    name: "Derek Pham",
    email: "dpham@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-018",
    name: "Nina Alvarado",
    email: "nalvarado@example-legalaid.org",
    role: "paralegal",
    jurisdiction: "Massachusetts",
  },
  {
    ...
    email: "soyelaran@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-020",
    name: "Claire Boucher",
    email: "cboucher@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-021",
    name: "Jordan Ellis",
    email: "jellis@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-022",
    name: "Maya Feldman",
    email: "mfeldman@example-legalaid.org",
    role: "paralegal",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-023",
    name: "Ben Okonkwo",
    email: "bokonkwo@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-024",
    name: "Rachel Stein",
    email: "rstein@example-legalaid.org",
    role: "support",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-025",
    name: "Victor Nguyen",
    email: "vnguyen@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-026",
    name: "Chloe Dupont",
    email: "cdupont@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-027",
    name: "Elias Brennan",
    email: "ebrennan@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    ...
    email: "fsiddiqui@example-legalaid.org",
    role: "paralegal",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-029",
    name: "Colin Doyle",
    email: "cdoyle@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-030",
    name: "Renee Ashworth",
    email: "rashworth@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-031",
    name: "Miguel Santos",
    email: "msantos@example-legalaid.org",
    role: "paralegal",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-032",
    name: "Ingrid Larsen",
    email: "ilarsen@example-legalaid.org",
    role: "advocate",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-033",
    name: "Devon Marsh",
    email: "dmarsh@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-034",
    name: "Yasmin Ali",
    email: "yali@example-legalaid.org",
    role: "support",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-035",
    name: "Patrick Nolan",
    email: "pnolan@example-legalaid.org",
    role: "attorney",
    jurisdiction: "Massachusetts",
  },
  {
    id: "lrn-036",
    name: "Beatrice Lowry",
    email: "blowry@example-legalaid.org",
    role: "support",
    jurisdiction: "Massachusetts",
  },
];
