...
> **The question every metric must serve:** *Is LACE effective for busy legal aid
> attorneys and advocates?* Not "are people logging in" — did the training fit into
...
Abandonment reasons are the metric completion rates can't give you: *why* busy people
...
*All numbers are fixture data until the pilot; the `DataResult.source` mock banner
rule applies to every new metric the same as the old ones.*
