...
_Replace the bracketed skill per course, e.g. "draft and file a summary process
answer" — concrete beats abstract._
...
_"No — no occasion" vs "No — didn't stick" is the distinction that matters:
one is a targeting problem, the other a teaching problem._
